docker build -t stephengrider/multi-client:latest stephengrider/multi-client:$SHA -f ./client/Dockerfile ./client
docker build -t stephengrider/multi-server:latest stephengrider/multi-server:$SHA -f ./server/Dockerfile ./server
docker build -t stephengrider/multi-worker:latest stephengrider/multi-worker:$SHA -f ./worker/Dockerfile ./worker
